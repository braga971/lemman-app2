...
import { exportCSV, exportPDF } from '../_integration/utils.js'
    ...
    <div className="grid">
      <div className="card">
        <div className="row">
          ...
          <button className="btn secondary" onClick={()=>exportCSV(rows, { ...data, profiles })}>Export CSV</button>
          <button className="btn secondary" onClick={()=>exportPDF(rows, { ...data, profiles })}>Export PDF</button>
        </div>
      </div>
      <div className="card">
